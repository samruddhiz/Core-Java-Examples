...
public class User {
	public static void main(String[] args)
	{
		...
		branch1.openAccount();
	   System.out.println("amount insured for Nationalised bank:" + 	branch1.amountInsured());
		
		Cooperative_Bank branch2 = new Cooperative_Bank("MyCBank", "Mumbai");
		branch2.openAccount();
		System.out.println("amount insured for Nationalised bank:" + 	branch2.amountInsured());
	}
}
